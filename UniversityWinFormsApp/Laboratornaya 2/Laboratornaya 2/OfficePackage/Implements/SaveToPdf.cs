...
namespace Laboratornaya_2.OfficePackage.Implements
{
    public class SaveToPdf : AbstractSaveToPdf
    {
        ...
        protected override void CreateRow(PdfRowParameters rowParameters)
        {
            ...
            if (rowParameters.RowHeight != null)
            {
                row.Height = (int)rowParameters.RowHeight;
            }
            for (int i = 0; i < rowParameters.Texts.Count; ++i)
            {
                ...
                if (i == 0 && rowParameters.RowHeight != null)
                {
                    row.Cells[i].Style = "NormalTitle";
                }
        ...
        protected override void SavePdf(PdfInfo info)
        {
            ...
            renderer.PdfDocument.Save(info.Path);
        }
    }
}
